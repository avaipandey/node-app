         ...
         stage('Deploy to GKE Docker Image'){
            steps{
                 withCredentials([file(credentialsId: 'jacc', variable: 'gke')]) {
                     ...
                     sh "gcloud compute scp --strict-host-key-checking=no jenkins@instance-2/serivces.yml jenkins@instance-2/pods.yml jenkins1@robotic-tract-277114.iam.gserviceaccount.com/home/jenkins1/"
                     sh "kubectl apply -f"
                  }
